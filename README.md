...
All analysis code is included in the repository. However, to comply with the terms of use of BIGSdb, which prohibits the large-scale redistribution of MLST allele profiles and sequence type definitions (see [here](https://pubmlst.org/terms-conditions) and [here](https://bigsdb.pasteur.fr/policy/)), some data are only provided as minimal summaries to enable reproduction of the published analyses.
